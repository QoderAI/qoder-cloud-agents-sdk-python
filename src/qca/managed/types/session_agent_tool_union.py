...
if TYPE_CHECKING:
    ...
    from .session_agent_tool_union_default_config import SessionAgentToolUnionDefaultConfig

__all__ = ["SessionAgentToolUnion"]
...
class SessionAgentToolUnion(BaseModel):
    ...
    default_config: Optional[SessionAgentToolUnionDefaultConfig] = None
