...
if TYPE_CHECKING:
    ...
    from .session_stream_event_stop_reason import SessionStreamEventStopReason
    from .session_stream_event_usage import SessionStreamEventUsage
...
class SessionStreamEvent(BaseModel):
    ...
    stop_reason: Optional[SessionStreamEventStopReason] = None
    agent_name: Optional[str] = None
    iteration: Optional[int] = None
    outcome_id: Optional[str] = None
    explanation: Optional[str] = None
    outcome_evaluation_start_id: Optional[str] = None
    usage: Optional[SessionStreamEventUsage] = None
